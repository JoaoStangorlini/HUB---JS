      ...
      <main className="pt-32 pb-24 px-6 max-w-7xl mx-auto space-y-32 relative z-10">
        ...
        <section className="space-y-12" id="projects">
          ...
          <div className="grid grid-cols-1 md:grid-cols-12 gap-6">
            ...
            <div className="md:col-span-12 bg-[#121212] border border-[#2D2D2D] p-8 rounded-2xl flex flex-col md:flex-row justify-between items-center min-h-[150px] hover:border-[#F5F5F5] transition-colors gap-6">
              ...
              <a href="https://github.com/JoaoStangorlini" target="_blank" rel="noreferrer" className="shrink-0 px-8 py-3 bg-[#F5F5F5] text-[#121212] text-sm font-bold rounded-md hover:bg-[#D4D4D4] transition-colors flex items-center gap-2">
                Acessar GitHub
                <span>→</span>
              </a>
            </div>
        ...
        <section className="space-y-12" id="academic">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="bg-[#1E1E1E] border border-[#2D2D2D] p-8 rounded-2xl flex flex-col justify-between min-h-[200px] hover:border-[#3B1E43] transition-colors gap-6 group">
            ...
            <div className="bg-[#1E1E1E] border border-[#2D2D2D] p-8 rounded-2xl flex flex-col justify-between min-h-[200px] hover:border-[#0F4780] transition-colors gap-6 group">
              <div className="space-y-2">
