  ...
  return (
    <nav className="w-full bg-cosmic-surface border-b border-cosmic-surface-hover px-6 py-4 flex items-center justify-between z-50 relative">
      <div className="flex items-center gap-8">
        <Link href="/">
          <h1 className="font-bold text-xl text-cosmic-accent cursor-pointer">Stangorlini.web</h1>
        </Link>
        
        <div className="hidden md:flex gap-6 items-center">
          
          {/* LabDiv Link */}
          <Link href="/labdiv" className="text-cosmic-text hover:text-cosmic-accent transition-colors py-2">
            LabDiv
          </Link>
