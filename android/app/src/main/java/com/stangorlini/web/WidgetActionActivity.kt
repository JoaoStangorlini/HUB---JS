...
class WidgetActionActivity : Activity() {
    ...
    private fun showStatusDialog(taskId: String) {
        val statuses = arrayOf("Rascunho", "Não Iniciada", "Em Progresso", "Falta Testar", "Completa", "Descartada")
        val internalStatuses = arrayOf("rascunho", "não iniciada", "em progresso", "falta testar", "completa", "descartada")
